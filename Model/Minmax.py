...
class Minmax:
    ...
    def minmax_mutli(self, current_board, depth):
        neighbours=self.b.get_neighbours(current_board[0],True)
        t = []
        for n in neighbours:
            t.append((n, depth - 1,False))
    ...
    def minimax(self,param ):
        current_board , depth, maximizingPlayer=param # current_board fe elawl tb3tlaha tuple (el board,-1)
